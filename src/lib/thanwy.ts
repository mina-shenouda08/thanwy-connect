...
export const gradeLabel = (v?: string | null) =>
  GRADES.find((g) => g.value === v)?.label ?? "—";
...
export const PRAYERS = [
  ...
  { key: "confession", label: "اخر اعتراف" },
] as const;
...
export const OLD_TESTAMENT = [
  ...
  "نشيد الأناشيد","إشعياء","إرميا","مراثي إرميا","حزقيال","دانيال","هوشع","يوئيل",
  "عاموس","عوبديا","يونان","ميخا","ناحوم","حبقوق","صفنيا","حجي","زكريا","ملاخي",
];

export const NEW_TESTAMENT = [
  "إنجيل متى","إنجيل مرقس","إنجيل لوقا","إنجيل يوحنا","أعمال الرسل","رومية",
  ...
  "تيطس","فليمون","العبرانيين","يعقوب","بطرس الأولى","بطرس الثانية","يوحنا الأولى",
